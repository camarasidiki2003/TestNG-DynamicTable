...
public class TestNGCustomer {
	// declaration of the webDriver
		...
		public void d() {
			...
			// String actualUrl="";
			//Assert.assertEquals(driver.findElement(DASHBOARD_HEADER_FIELD).getTagName(), "Dashboard", "wrong page");
		...
		private void waitForElement(WebDriver driver, Duration timeInSeconds, By locator) {
